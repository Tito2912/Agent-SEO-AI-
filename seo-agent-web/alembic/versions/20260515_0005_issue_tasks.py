...
def upgrade() -> None:
    ...
    if not _has_table(conn, "issue_tasks"):
        op.create_table(
            ...
            sa.Column("issue_label", sa.String(512), nullable=False, server_default=text("''")),
            sa.Column("crawl_ts", sa.String(32), nullable=False, server_default=text("''")),
            sa.Column("url", sa.String(2048), nullable=True),
            sa.Column("severity", sa.String(32), nullable=False, server_default=text("'notice'")),
            sa.Column("status", sa.String(32), nullable=False, server_default=text("'todo'")),
        ...
        op.create_index("ix_issue_tasks_user_id", "issue_tasks", ["user_id"])
