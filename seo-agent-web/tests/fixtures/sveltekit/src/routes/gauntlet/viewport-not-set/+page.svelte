...
<svelte:head>
  ...
  <link rel="canonical" href="https://noyaru-stack-sveltekit.netlify.app/gauntlet/viewport-not-set" />
  ...
  <meta property="og:url" content="https://noyaru-stack-sveltekit.netlify.app/gauntlet/viewport-not-set" />
