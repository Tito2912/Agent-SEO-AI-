+++
url = "/gauntlet/multiple-title-tags"
title = 'Page de test du parcours d obstacles Noyaru'
html_attrs = ' lang="fr"'
raw_head = '''
  <!-- FAMILLE VISEE : multiple_title_tags — deux balises «title». -->
  <meta name="viewport" content="width=device-width" />
  <title>Page de test du parcours d'obstacles Noyaru</title>
  <title>Un second titre</title>
  ...
  <link rel="canonical" href="https://noyaru-stack-hugo.netlify.app/gauntlet/multiple-title-tags" />
  ...
  <meta property="og:url" content="https://noyaru-stack-hugo.netlify.app/gauntlet/multiple-title-tags" />
...
'''
raw_body = '''
  <h1>Parcours d'obstacles : multiple title tags</h1>
  <p>Cette page du parcours traite le cas « multiple title tags ». Cette page appartient au parcours d'obstacles de la fixture. Elle sert a provoquer UNE anomalie et une seule.</p>
