+++
url = "/gauntlet/viewport-not-set"
title = 'Page de test du parcours d obstacles Noyaru'
html_attrs = ' lang="fr"'
raw_head = '''
  <!-- FAMILLE VISEE : viewport_not_set — aucune meta viewport. -->
  ...
  <link rel="canonical" href="https://noyaru-stack-hugo.netlify.app/gauntlet/viewport-not-set" />
  ...
  <meta property="og:url" content="https://noyaru-stack-hugo.netlify.app/gauntlet/viewport-not-set" />
...
'''
raw_body = '''
  <h1>Parcours d'obstacles : viewport not set</h1>
  <p>Cette page du parcours traite le cas « viewport not set ». Cette page appartient au parcours d'obstacles de la fixture. Elle sert a provoquer UNE anomalie et une seule.</p>
