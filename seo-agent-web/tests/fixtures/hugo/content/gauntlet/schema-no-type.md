+++
url = "/gauntlet/schema-no-type"
title = 'Page de test du parcours d obstacles Noyaru'
html_attrs = ' lang="fr"'
raw_head = '''
  <!-- FAMILLE VISEE : structured_data_schema_org_validation_error — objet schema.org sans @type declare. -->
  ...
  <link rel="canonical" href="https://noyaru-stack-hugo.netlify.app/gauntlet/schema-no-type" />
  ...
  <meta property="og:url" content="https://noyaru-stack-hugo.netlify.app/gauntlet/schema-no-type" />
