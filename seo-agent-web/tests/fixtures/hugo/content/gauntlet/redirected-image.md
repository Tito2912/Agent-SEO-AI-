+++
url = "/gauntlet/redirected-image"
title = 'Page de test du parcours d obstacles Noyaru'
html_attrs = ' lang="fr"'
raw_head = '''
  <!-- FAMILLE VISEE : image_redirects + page_has_redirected_image — image chargee depuis une URL qui redirige. -->
  ...
  <link rel="canonical" href="https://noyaru-stack-hugo.netlify.app/gauntlet/redirected-image" />
  ...
  <meta property="og:url" content="https://noyaru-stack-hugo.netlify.app/gauntlet/redirected-image" />
...
raw_body = '''
  ...
  <img src="https://noyaru-stack-hugo.netlify.app/img/ancienne.png" alt="Illustration de test" />
'''
+++
