...
useHead({
    ...
    meta: [
      ...
      { name: 'description', content: 'Une seconde description.' },
      ...
      { property: 'og:url', content: 'https://noyaru-stack-nuxt.netlify.app/gauntlet/multiple-meta-description-tags' },
    ...
    link: [
      { rel: 'canonical', href: 'https://noyaru-stack-nuxt.netlify.app/gauntlet/multiple-meta-description-tags' }
    ],
});
</script>
