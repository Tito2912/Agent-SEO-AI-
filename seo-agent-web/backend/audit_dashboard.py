...
ISSUE_CATALOG: dict[str, IssueMeta] = {
    ...
    "title_tag_changed": IssueMeta("title_tag_changed", "Title tag changed", "Content", "notice"),
    ...
    "missing_title": IssueMeta("missing_title", "Title manquant / vide", "Content", "warning"),
    ...
    "page_and_serp_titles_do_not_match": IssueMeta(
        "page_and_serp_titles_do_not_match", "Page and SERP titles do not match", "Content", "notice"
    ),
    "title_too_long": IssueMeta("title_too_long", "Title trop long", "Content", "notice"),
    "title_too_long_indexable": IssueMeta("title_too_long_indexable", "Title trop long", "Content", "warning"),
    "title_too_long_not_indexable": IssueMeta("title_too_long_not_indexable", "Title trop long", "Content", "notice"),
    "title_too_short": IssueMeta("title_too_short", "Title trop court", "Content", "notice"),
